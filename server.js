...
//Wiener Linien API Request
const WL_API_REQ ="https://www.wienerlinien.at/ogd_realtime/monitor?diva=60200500&activateTrafficInfo=stoerunglang&activateTrafficInfo=aufzugsinfo";

fetch_wl_station();
function fetch_wl_station(/*stationDIVA*/){
    return fetch(WL_API_REQ)
        .then(response => response.json())
        .then(data => console.log(data.data.monitors[0]))
